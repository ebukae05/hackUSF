            ...
            return (
              <div key={match.match_id} className="rounded-xl border border-border p-4 bg-background/40">
                ...
                <div className="mt-3 text-xs text-muted-foreground space-y-1">
                  <p><span className="text-cloud-signal">Route:</span> {match.routing_plan.origin} to {match.routing_plan.destination}</p>
                  <p><span className="text-cloud-signal">ETA:</span> {match.routing_plan.eta_hours}h</p>
                </div>
